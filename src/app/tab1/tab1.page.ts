...
export class Tab1Page {
  ...
  constructor(
    ...
    public sharedService: SharedService // Injeta o serviço compartilhado
  ) { }
  ...
  buscarPokemon() {
    this.viaCEPService.getViaCEPService(this.areaBuscarPokemon)
      .subscribe((value) => {
        ...
        this.sharedService.setAreaBusca(this.areaBusca);
      });
    ...
    this.pokeAPIService.getPokeAPIService()
      .subscribe((value) => {
        ...
        this.pokemon.draw        = 0;
        this.pokemon.loss        = 0;
        this.sharedService.setPokemonData(this.pokemon); // Atualizado para usar o serviço compartilhado
      });
  }
}
